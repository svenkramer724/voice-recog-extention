...
var googleDocsUtil = function() {
    ...
    function getGoogleDocument() {
		...
		// Version 1.5.2 - By Jeff - New way of getting previousText so we can have bold and colored text on same line (multiple nodes)
		for (var n = 0; n < nodes.length; n++) {
			if (nodes[n].line == caretLine)
				previousText += nodes[n].text;
		}
		previousText = previousText.substring(0, caretLineIndex);
